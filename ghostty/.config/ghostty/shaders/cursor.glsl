...
// Subtle gray cursor trail - matches JetBrains IDE theme
const vec4 TRAIL_COLOR = vec4(0.74, 0.75, 0.77, 0.12);        // subtle gray (#BCBEC4)
const vec4 TRAIL_COLOR_ACCENT = vec4(0.75, 0.57, 0.98, 0.08);  // subtle magenta
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const float DURATION = 0.12;
const float OPACITY = 0.12;
const float DRAW_THRESHOLD = 2.5;
